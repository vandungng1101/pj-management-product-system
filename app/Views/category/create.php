...
<body>
    ...
    <div style="width: 25%;" class="mx-auto rounded-3">
        <form action="/category/save-create" method="post" class="bg-info rounded-3 p-3">
            <div class="">
                <label class="form-label">Tên loại sản phẩm: </label>
                <input type="text" name="cate_name" id="" class="form-control" placeholder=". . ." value="<?= old('cate_name', isset($oldInput['cate_name']) ? $oldInput['cate_name'] : ''); ?>">
                <?php
